...
function wfm_setting_reset(){
  ...
  update_option('wfm_display_image',1);
...
function wfm_setting(){
  ...
  //------------------
    ...
    if(isset($_POST['wfm_status_submit']) && $_POST['wfm_status_submit']==1){
      ...
      update_option('wfm_display_image',$_POST['wfm_display_image']);
...
<!--                  <option value="0"<?php //if (get_option('wfm_display_variation')=='0'):?> selected="selected"<?php //endif;?>>No</option>                -->
        ...
        <tr valign="top"> 
          <td width="150" scope="row">Display Image:</td>
          <td>
              <select name="wfm_display_image">
                  <option value="1"<?php if (get_option('wfm_display_image')=='1'):?> selected="selected"<?php endif;?>>Yes</option>
                  <option value="0"<?php if (get_option('wfm_display_image')=='0'):?> selected="selected"<?php endif;?>>No</option>                
              </select>
          </td>
        </tr>
        <tr valign="top"> 
