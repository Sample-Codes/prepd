...
<script>
  ...
  //-------------------------------------
  var img_url_plus = '<? echo WFM_BASE_URL; ?>/images/plus.png';
  var img_url_minus = '<? echo WFM_BASE_URL; ?>/images/minus.png';
...
function wfm_show_prod($id, $wfm_img_size, $post_title){
  wrm_item_custom_field($id);
    ...
    if (get_option('wfm_display_image')=='1'){
      if (get_option('wfm_display_image_preview')=='1'){
        echo '<td><a href="'.$img_url2.'" class="preview"><img src="'.$img_url.'" height="'.$wfm_img_size.'" width="'.$wfm_img_size.'" /></a></td>';
      }else{                
        echo '<td><img src="'.$img_url.'" height="'.$wfm_img_size.'" width="'.$wfm_img_size.'" /></td>';
      }
    }
    echo '<td class="wfm_td">'.$product_name.'<div class="wfm_des">'.$prod_des.'</div></td>';
    //-----------------------------Custom Field------------------------------------------
    $cf_data='';
    $cf='';              
