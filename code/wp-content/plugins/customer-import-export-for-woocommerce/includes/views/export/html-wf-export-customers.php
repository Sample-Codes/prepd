<div class="tool-box">
    ...
    <form action="<?php echo admin_url('admin.php?page=hf_wordpress_customer_im_ex&action=export'); ?>" method="post">
        ...
        <table class="form-table">
            ...
            <tr>
                <th>
                    <label for="v_start_date"><?php _e('Start Date', 'wf_customer_import_export'); ?></label>
                </th>
                <td>
                    <input type="text" name="start_date"  id="v_start_date" />
                    <p>Format: <code>YYYY-MM-DD.</code></p>    
                    <p><?php _e('Pick a start user registration date to limit the results.', 'wf_customer_import_export');?></p>
                </td>
            </tr>
            <tr>
                <th>
                    <label for="v_end_date"><?php _e('End Date', 'wf_customer_import_export'); ?></label>
                </th>
                <td>
                    <input type="text" name="end_date"  id="v_end_date" />
                    <p>Format: <code>YYYY-MM-DD.</code></p>
                    <p><?php _e('Pick an end user registration date to limit the results.', 'wf_customer_import_export');?></p>
                </td>
            </tr>
            <tr>
                <th>
