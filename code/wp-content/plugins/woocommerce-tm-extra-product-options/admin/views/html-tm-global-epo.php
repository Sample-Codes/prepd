...
?>
        ...
        if (TM_EPO_WPML()->is_original_product($post_id)){
            ...
            echo '<div class="message0x0 tc-clearfix">'.
                    '<div class="message2x1">'.
                        '<label for="tm_meta_cpf_price_override"><span>'.__( 'Override product price', TM_EPO_TRANSLATION ).'</span></label>'.
                        '<span class="woocommerce-help-tip" data-tip="'.esc_attr(__( 'This will override the product price with the price from the options if the total options price is greater then zero.', TM_EPO_TRANSLATION )).'"></span>'.
                        '<div class="messagexdesc">&nbsp;</div>'.
                    '</div>'.
                    '<div class="message2x2">'.
