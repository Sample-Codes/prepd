<?php
// if(!empty($_GET['page']) == 'wf_coupon_csv_im_ex')
// {
// 	$tab = 'coupon';
// }
...
<div class="wrap woocommerce">
    ...
    <h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
        ...
        <a href="<?php echo admin_url('admin.php?page=wf_woocommerce_subscription_order_im_ex&tab=subscription') ?>" class="nav-tab <?php echo ($tab == 'subscription') ? 'nav-tab-active' : ''; ?>"><?php _e('Subscription Import / Export', 'wf_order_import_export'); ?></a>
	<a href="<?php echo admin_url('admin.php?page=wf_woocommerce_order_im_ex&tab=settings') ?>" class="nav-tab <?php echo ($tab == 'settings') ? 'nav-tab-active' : ''; ?>"><?php _e('Export Settings', 'wf_order_import_export'); ?></a>
