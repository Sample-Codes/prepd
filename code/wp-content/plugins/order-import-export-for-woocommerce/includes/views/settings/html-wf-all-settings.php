...
wp_localize_script('woocommerce-coupon-csv-importer', 'woocommerce_coupon_csv_cron_params', array('cpn_enable_ftp_ie' => $cpn_enable_ftp_ie , 'cpn_auto_export' => $cpn_auto_export, 'cpn_auto_import' => $cpn_auto_import));
...
if ($ord_scheduled_timestamp = wp_next_scheduled('wf_coupon_csv_im_ex_auto_export_coupons')) {
    ...
    <form action="<?php echo admin_url('admin.php?page=wf_woocommerce_order_im_ex&action=settings'); ?>" method="post">
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="ord_ftp_user" id="ord_ftp_user" placeholder="<?php _e('', 'wf_order_import_export'); ?>" value="<?php echo $ord_ftp_user; ?>" class="input-text" />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="password" name="ord_ftp_password" id="ord_ftp_password" placeholder="<?php _e('', 'wf_order_import_export'); ?>" value="<?php echo $ord_ftp_password; ?>" class="input-text" />
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tbody class="ord_import_section">
                <tr>
                    ...
                    <td>
                        <input type="text" name="ord_auto_import_start_time" id="ord_auto_export_start_time"  value="<?php echo $ord_auto_import_start_time; ?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="ord_auto_import_interval" id="ord_auto_export_interval"  value="<?php echo $ord_auto_import_interval; ?>"  />
                    </td>
                </tr>
                ...
                if (!empty($ord_mapping_from_db)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="ord_auto_import_profile">
        ...
        <table class="form-table">
            ...
            <tbody class="sbc_import_section">
                <tr>
                    ...
                    <td>
                        <input type="text" name="sbc_auto_import_start_time" id="sbc_auto_export_start_time"  value="<?php echo $sbc_auto_import_start_time; ?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="sbc_auto_import_interval" id="sbc_auto_export_interval"  value="<?php echo $sbc_auto_import_interval; ?>"  />
                    </td>
                </tr>
                <tr>
                    <th>
                ...
                if (!empty($sbc_mapping_from_db)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="sbc_auto_import_profile">
                                <option value="">--Select--</option>
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="cpn_ftp_user" id="cpn_ftp_user" placeholder="<?php _e('', 'wf_order_import_export'); ?>" value="<?php echo $cpn_ftp_user; ?>" class="input-text" />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="password" name="cpn_ftp_password" id="cpn_ftp_password" placeholder="<?php _e('', 'wf_order_import_export'); ?>" value="<?php echo $cpn_ftp_password; ?>" class="input-text" />
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tbody class="cpn_import_section">
                <tr>
                    ...
                    <td>
                        <input type="text" name="cpn_auto_import_start_time" id="auto_export_start_time"  value="<?php echo $cpn_auto_import_start_time; ?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="cpn_auto_import_interval" id="cpn_auto_export_interval"  value="<?php echo $cpn_auto_import_interval; ?>"  />
                    </td>
                </tr>
                ...
                if (!empty($cpn_mapping_from_db)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="cpn_auto_import_profile">
                                <option value="">--Select--</option>
