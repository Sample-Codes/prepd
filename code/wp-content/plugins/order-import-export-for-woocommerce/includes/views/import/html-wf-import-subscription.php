<div class="tool-box">
    ...
    <p class="submit">
        <?php
        $merge_url = admin_url('admin.php?import=woocommerce_wf_subscription_order_csv&merge=1');
        $import_url = admin_url('admin.php?import=woocommerce_wf_subscription_order_csv');
        ?>
        <a class="button button-primary" id="mylink" href="<?php echo admin_url('admin.php?import=woocommerce_wf_subscription_order_csv'); ?>"><?php _e('Import Subscription Orders', 'wf_order_import_export'); ?></a>
        &nbsp;
