...
class WF_SubscriptionOrderImpExpCsv_ImportCron {
    ...
    public function hf_scheduled_import_subscription_order() {
        ...
        if($this->handle_ftp_for_autoimport()){
            ...
            if($this->settings['sbc_auto_import_profile']!== ''){
                ...
                $GLOBALS['HF_CSV_Subscription_Order_Import']->log->add( 'csv-import', __( 'Failed processing import. Reason:'.$this->error_message, 'wf_order_import_export' ) );
            }
	...
	$GLOBALS['HF_CSV_Subscription_Order_Import']->import_end();
        ...
        die();
            ...
            $GLOBALS['HF_CSV_Subscription_Order_Import']->log->add( 'csv-import', __( 'Fetching file failed. Reason:'.$this->error_message, 'wf_order_import_export' ) );
        }
