<?php
/**
 * Template Name: Weekly Menu Week 2
 *
 */
get_header('banner');
?>
              ...
              <div class="col-sm-6">
                <div class="square-box">
                  ...
                  <h4>This Week's Meals</h4>
                    <?php
                      $meals = new WP_Query( array( 'post_type' => 'meal', 'posts_per_page' => -1, 'post_status' => 'publish', 'meal-category' => 'week two' ) );
                      if ( $meals->have_posts() ) :
            ...
            <div class="col-sm-6">
                <div class="square-box">
                  ...
                  <h4>This Week's Snacks</h4>
                     <?php
                      $meals = new WP_Query( array( 'post_type' => 'snack', 'posts_per_page' => -1, 'post_status' => 'publish', 'meal-category' => 'week two' ) );
                      if ( $meals->have_posts() ) :
                        while ( $meals->have_posts() ) : $meals->the_post(); 
                     ?>
